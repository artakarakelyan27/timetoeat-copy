...
function useSeoHead(opts) {
  const { siteUrl } = useRuntimeConfig().public;
  const canonical = `${siteUrl}${opts.path}`;
  const ogImage = opts.ogSlug ? `${siteUrl}/og/${opts.ogSlug}.png` : `${siteUrl}/og/default.png`;
  useSeoMeta({
    title: opts.title,
...
export { useSeoHead as u };
//# sourceMappingURL=useSeoHead-Cf0asDsx.mjs.map
