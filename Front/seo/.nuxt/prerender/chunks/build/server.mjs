import { hasInjectionContext, inject, getCurrentInstance, ref, watchEffect, watch, unref, version, defineComponent, h, computed, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, createApp, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, mergeProps, toRef, defineAsyncComponent, getCurrentScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'file:///var/www/time-to-eat-copy/Front/node_modules/.pnpm/vue@3.5.12_typescript@5.6.2/node_modules/vue/index.mjs';
...
import { hasProtocol, isScriptProtocol, joinURL, withQuery, withBase } from 'file:///var/www/time-to-eat-copy/Front/node_modules/ufo/dist/index.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file:///var/www/time-to-eat-copy/Front/node_modules/hookable/dist/index.mjs';
...
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///var/www/time-to-eat-copy/Front/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///var/www/time-to-eat-copy/Front/node_modules/.pnpm/unhead@1.11.20/node_modules/unhead/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///var/www/time-to-eat-copy/Front/node_modules/.pnpm/vue-router@4.4.5_vue@3.5.12_typescript@5.6.2_/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///var/www/time-to-eat-copy/Front/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///var/www/time-to-eat-copy/Front/node_modules/.pnpm/vue@3.5.12_typescript@5.6.2/node_modules/vue/server-renderer/index.mjs';
...
function Ns() {
  return bi || (bi = 1, function(i, o2) {
    (function(a, f2) {
      ...
      function _a2(e, t2) {
        ue(e, t2);
        const r2 = e == null ? void 0 : e.abort, s = e == null ? void 0 : e.close, u = e == null ? void 0 : e.start, c = e == null ? void 0 : e.type, d = e == null ? void 0 : e.write;
      ...
      function fs(e, t2) {
        ue(e, t2);
        const r2 = e, s = r2 == null ? void 0 : r2.autoAllocateChunkSize, u = r2 == null ? void 0 : r2.cancel, c = r2 == null ? void 0 : r2.pull, d = r2 == null ? void 0 : r2.start, m = r2 == null ? void 0 : r2.type;
      ...
      function Yo(e, t2) {
        ue(e, t2);
        const r2 = e == null ? void 0 : e.preventAbort, s = e == null ? void 0 : e.preventCancel, u = e == null ? void 0 : e.preventClose, c = e == null ? void 0 : e.signal;
      ...
      function gs(e, t2) {
        ue(e, t2);
        const r2 = e == null ? void 0 : e.cancel, s = e == null ? void 0 : e.flush, u = e == null ? void 0 : e.readableType, c = e == null ? void 0 : e.start, d = e == null ? void 0 : e.transform, m = e == null ? void 0 : e.writableType;
...
const mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-DH0dw97p.mjs');
...
const o = !!((_b = (_a = globalThis.process) == null ? void 0 : _a.env) == null ? void 0 : _b.FORCE_NODE_FETCH), r = !o && globalThis.fetch || Mi, n = !o && globalThis.Headers || ye, T = !o && globalThis.AbortController || Mn;
...
const unhead_2Qa8mqAKcK = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-H58EPmoI.mjs')
  },
  {
    name: "chto-prigotovit",
    path: "/chto-prigotovit",
    component: () => import('./index-BDmCmBEW.mjs')
  },
  {
    name: "chto-prigotovit-iz-togo-chto-est",
    path: "/chto-prigotovit/iz-togo-chto-est",
    component: () => import('./iz-togo-chto-est-bSNQUGnH.mjs')
  },
  {
    name: "gotovim-vprok",
    path: "/gotovim-vprok",
    component: () => import('./index-wZ5lA0kJ.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CMVZG3W3.mjs')
  },
  {
    name: "iz-ostatkov-slug",
    path: "/iz-ostatkov/:slug()",
    component: () => import('./_slug_-BifQ1IWU.mjs')
  },
  {
    name: "iz-ostatkov",
    path: "/iz-ostatkov",
    component: () => import('./index-DbwNXRTN.mjs')
  },
  {
    name: "iz-ingredient",
    path: "/iz/:ingredient()",
    component: () => import('./_ingredient_-sMUK49k3.mjs')
  },
  {
    name: "iz",
    path: "/iz",
    component: () => import('./index-w5os9wNO.mjs')
  },
  {
    name: "menyu-na-nedelyu-segment",
    path: "/menyu-na-nedelyu/:segment()",
    component: () => import('./_segment_-DSqDWKlb.mjs')
  },
  {
    name: "menyu-na-nedelyu",
    path: "/menyu-na-nedelyu",
    component: () => import('./index-B5_dcPdM.mjs')
  },
  {
    name: "o-proekte",
    path: "/o-proekte",
    component: () => import('./o-proekte-DO97ZKjI.mjs')
  },
  {
    name: "recepty-slug",
    path: "/recepty/:slug()",
    component: () => import('./_slug_-B-TiRsw5.mjs')
  },
  {
    name: "recepty",
    path: "/recepty",
    component: () => import('./index-CFeT4Dtp.mjs')
  },
  {
    name: "spravochnik",
    path: "/spravochnik",
    component: () => import('./index-CSp_E45o.mjs')
  },
  {
    name: "spravochnik-srok-khraneniya-slug",
    path: "/spravochnik/srok-khraneniya/:slug()",
    component: () => import('./_slug_-BZmRWii_.mjs')
  },
  {
    name: "spravochnik-zameny-slug",
    path: "/spravochnik/zameny/:slug()",
    component: () => import('./_slug_-DFVPskj8.mjs')
  }
];
...
const revive_payload_server_8MC3WdxbHl = /* @__PURE__ */ defineNuxtPlugin({
...
let routes;
const prerender_server_Hnj2A1snxb = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
...
const plugins = [
  unhead_2Qa8mqAKcK,
  plugin,
  revive_payload_server_8MC3WdxbHl,
  components_plugin_KR1HBZs4kY,
  prerender_server_Hnj2A1snxb
];
const layouts = {
  default: () => import('./default-Dfi30wMe.mjs')
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      titleTemplate: (title) => title ? `${title} — Время Есть` : "Время Есть — меню на неделю за 60 секунд"
    });
    const { ymCounter } = (/* @__PURE__ */ useRuntimeConfig()).public;
    if (ymCounter) {
      useHead({
        script: [
          {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><a class="skip-link" href="#main">Перейти к содержимому</a>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DgD-wLu5.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DUoBbvwV.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.5.6_@types+node@22.7.4_db0@0.3.4_ioredis@5.10.1_lightning_4d6c68a1855b9ba02a2e67c7168efc5c/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.5.6_@types+node@22.7.4_db0@0.3.4_ioredis@5.10.1_lightning_4d6c68a1855b9ba02a2e67c7168efc5c/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { asyncDataDefaults as a, br as b, createError as c, nuxtLinkDefaults as d, entry_default as default, useNuxtApp as e, useRoute as f, useRouter as g, useRuntimeConfig as h, navigateTo as n, qn as q, resolveRouteObject as r, useHead as u };
