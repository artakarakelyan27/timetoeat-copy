...
const srokKhraneniya_get = defineEventHandler(async (event) => {
  const slug = getQuery(event).slug;
  const data = await loadYaml("reference/srok-khraneniya.yaml");
  if (slug) {
...
export { srokKhraneniya_get as default };
//# sourceMappingURL=srok-khraneniya.get.mjs.map
